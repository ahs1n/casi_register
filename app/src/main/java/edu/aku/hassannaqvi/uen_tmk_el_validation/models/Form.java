...
public class Form extends LiveData<Form> {
    ...
    public Form Sync(JSONObject jsonObject) throws JSONException {
        ...
        this.elb1 = jsonObject.getString(FormsTable.COLUMN_CR05);
        this.elb2 = jsonObject.getString(FormsTable.COLUMN_CR06);
        this.elb3 = jsonObject.getString(FormsTable.COLUMN_CR07);
        this.elb4 = jsonObject.getString(FormsTable.COLUMN_CR08);
        this.elb5 = jsonObject.getString(FormsTable.COLUMN_CR09);
        this.elb6 = jsonObject.getString(FormsTable.COLUMN_CR10);
    ...
    public Form Hydrate(Cursor cursor) {
        ...
        this.elb1 = cursor.getString(cursor.getColumnIndex(FormsTable.COLUMN_CR05));
        this.elb2 = cursor.getString(cursor.getColumnIndex(FormsTable.COLUMN_CR06));
        this.elb3 = cursor.getString(cursor.getColumnIndex(FormsTable.COLUMN_CR07));
        this.elb4 = cursor.getString(cursor.getColumnIndex(FormsTable.COLUMN_CR08));
        this.elb5 = cursor.getString(cursor.getColumnIndex(FormsTable.COLUMN_CR09));
        this.elb6 = cursor.getString(cursor.getColumnIndex(FormsTable.COLUMN_CR10));
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            json.put(FormsTable.COLUMN_CR05, this.elb1 == null ? JSONObject.NULL : this.elb1);
            json.put(FormsTable.COLUMN_CR06, this.elb2 == null ? JSONObject.NULL : this.elb2);
            json.put(FormsTable.COLUMN_CR07, this.elb3 == null ? JSONObject.NULL : this.elb3);
            json.put(FormsTable.COLUMN_CR08, this.elb4 == null ? JSONObject.NULL : this.elb4);
            json.put(FormsTable.COLUMN_CR09, this.elb5 == null ? JSONObject.NULL : this.elb5);
            json.put(FormsTable.COLUMN_CR10, this.elb6 == null ? JSONObject.NULL : this.elb6);
